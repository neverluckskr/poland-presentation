...
export default function InfoCard({ card, isActive, onClick }) {
  ...
  return (
    ...
    >
      ...
      <span className="text-sm xs:text-base sm:text-lg md:text-xl font-extrabold inline-block" style={{ animation: 'numberFloat 3s ease-in-out infinite' }}>
