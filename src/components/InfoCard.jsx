...
export default function InfoCard({ card, isActive, onClick }) {
  ...
  return (
    ...
    >
      ...
      <strong className="block text-xs xs:text-sm sm:text-base text-primary mb-0.5 sm:mb-1 drop-shadow-[0_0_10px_rgba(239,68,68,0.5)]">
        {card.label}
      </strong>
      <span className="text-base xs:text-lg sm:text-xl font-extrabold inline-block" style={{ animation: 'numberFloat 3s ease-in-out infinite' }}>
