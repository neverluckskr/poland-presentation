  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center p-4 xs:p-6 sm:p-8 bg-gradient-to-br from-dark-bg/75 via-dark-bg/65 to-dark-bg/75 backdrop-blur-lg rounded-[32px]">
      <div className="text-center max-w-4xl mx-auto animate-fade-in">
        ...
        <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-4xl font-black md:font-extrabold text-primary mb-6 xs:mb-8 sm:mb-10 md:mb-12 drop-shadow-[0_0_25px_rgba(239,68,68,0.8)] animate-pulse-slow">
          {slide.subtitle}
        </h2>
