  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
        <div>
          <h3 className="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl text-primary mb-2 sm:mb-3 md:mb-4 font-bold">📜 Исторические факты</h3>
          ...
          <h3 className="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl text-primary mt-3 sm:mt-4 md:mt-5 lg:mt-6 mb-2 sm:mb-3 md:mb-4 font-bold">🎨 Культурные и научные факты</h3>
          <ul className="text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl list-none space-y-2 sm:space-y-3 md:space-y-4">
        ...
        <div>
          <h3 className="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl text-primary mb-2 sm:mb-3 md:mb-4 font-bold">🏔️ Географические факты</h3>
          <ul className="text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl list-none space-y-2 sm:space-y-3 md:space-y-4">
          ...
          <h3 className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-primary mt-3 sm:mt-4 md:mt-5 lg:mt-6 mb-2 sm:mb-3 md:mb-4 font-bold">👥 Социальные факты</h3>
